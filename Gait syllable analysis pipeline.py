...
dlc_result_path = r"D:\Expriment\Data\Acethylcholine\615_day2DLC_resnet101_CINJan4shuffle1_500000.csv"
...
# plt.figure(figsize=(12, 12))
# plt.subplot(4, 1, 1)
# # plt.plot(time_series, ffl_x+300, label='x distance of Left front Foot', color='k', alpha=0.7)
...
# # plt.plot(np.array(time_series)[peaksffl_x], ffl_x[peaksffl_x]+300, "x", label='Peaks', color='r')
# # plt.plot(np.array(time_series)[valleysffl_x], ffl_x[valleysffl_x]+300, "o", label='Valleys', color='g')
...
# plt.subplot(4, 1, 2)
# # plt.plot(time_series, ffr_x+300, label='x distance of Right front Foot', color='k', alpha=0.7)
...
# # plt.plot(np.array(time_series)[peaksffr_x], ffr_x[peaksffr_x]+300, "x", label='Peaks', color='r')
# # plt.plot(np.array(time_series)[valleysffr_x], ffr_x[valleysffr_x]+300, "o", label='Valleys', color='g')
...
# plt.subplot(4, 1, 3)
# # plt.plot(time_series, fhl_x+300, label='x distance of Left hint Foot', color='k', alpha=0.7)
...
# # plt.plot(np.array(time_series)[peaksfhl_x], fhl_x[peaksfhl_x]+300, "x", label='Peaks', color='r')
# # plt.plot(np.array(time_series)[valleysfhl_x], fhl_x[valleysfhl_x]+300, "o", label='Valleys', color='g')
...
# plt.subplot(4, 1, 4)
# # plt.plot(time_series, fhr_x+300, label='x distance of Right hint Foot', color='k', alpha=0.7)
...
# # plt.plot(np.array(time_series)[peaksfhr_x], fhr_x[peaksfhr_x]+300, "x", label='Peaks', color='r')
# # plt.plot(np.array(time_series)[valleysfhr_x], fhr_x[valleysfhr_x]+300, "o", label='Valleys', color='g')
